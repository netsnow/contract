    ...
    [          '$stateProvider', '$urlRouterProvider',
      function ($stateProvider,   $urlRouterProvider) {
          ...
          //custom start
              ...
              .state('app.deparment', {
                  url: '/deparment',
                  templateUrl: 'tpl/deparment_home.html',
                  resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load('ngGrid').then(
                              function(){
                                  return $ocLazyLoad.load('js/controllers/department.js');
                              }
                          );
                      }]
                  }
              ...
              .state('app.member', {
                  url: '/member',
                  templateUrl: 'tpl/member_home.html',
                  resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load('ngGrid').then(
              ...
              .state('app.contract', {
                  url: '/contract',
                  templateUrl: 'tpl/contract_home.html',
                  resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load('ngGrid').then(
                              function(){
                                  return $ocLazyLoad.load('js/controllers/contract.js');
                              }
                          );
                      }]
                  }
              ...
              .state('app.user_contract', {
                  url: '/user_contract',
                  templateUrl: 'tpl/user_contract_home.html',
                  resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load('ngGrid').then(
                              function(){
                                  return $ocLazyLoad.load('js/controllers/user_contract.js');
                              }
                          );
                      }]
                  }
